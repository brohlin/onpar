...
<script type="text/javascript">
	...
	$( document ).ready(function() {
        ...
        $("#add_row_0").click(function(){
        	i++; 
			$('#register_family_members_0 tr:last').after("<tr id=\"row" + i + "\"><td><select id=\"miembro_" + i + "\" name=\"miembro_" + i + "\"  size=\"1\" required=\"required\"><option value=\"\"></option><option value=\"Madre\">Madre</option><option value=\"Padre\">Padre</option><option value=\"Hijo\">Hijo/a</option><option value=\"Hermano\">Hermano/a)</option><option value=\"Otro\">Otro</option></select></td><td><input type=\"text\"  name=\"miembro_nombre_" + i + "\" value=\"\" size=\"25\" maxlength=\"40\" required></td><td><input type=\"text\"  name=\"miembro_edad_"  + i + "\" value=\"\" size=\"25\" maxlength=\"40\" required></td><td><input type=\"text\"  name=\"miembro_ocupacion_" + i + "\" value=\"\" size=\"25\" maxlength=\"40\"></td></tr>");		
