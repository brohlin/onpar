...
<%
	...
	params.add("Subió renuncia de solicitante.");
...
<%
	...
	String mQuery = "update declaracion_jurada set " + 
					"adm_estatus_lkup = 'Renuncia de Solicitante' , " +
					"fecha_de_renuncia = ? , " +
					"renuncia = ? , " + 
					"last_user_id = ? , " + 
					"last_mod_tmstmp = now()  " + 
	...
	String mFecha_de_renuncia = null;
      ...
      try{ 
         ...
         while ( i.hasNext () ) 
         {
            ...
            if ( !fi.isFormField () )	
            {
				...
				} else if (fieldName.equals("fecha_de_renuncia")) {
				 	mFecha_de_renuncia = fi.getString();
				}  
            }
         }
...
<%
	...
	try{
		if (session.getAttribute("email") != null) {
			...
			prest.setString(1,mFecha_de_renuncia);
