...
<%
	...
	params.add("Subió entrevista social.");
...
<%
	...
	String mQuery = "update declaracion_jurada set " +
					"adm_estatus_lkup = if(pre_declaracion_jurada is not null and pre_entrevista_legal is not null and pre_entrevista_social is null and renuncia is null and quitar_refug_recon is null and pre_estatus_lkup != 'Digitalizar Caso Cerrado','En proceso - original',adm_estatus_lkup), " + 
