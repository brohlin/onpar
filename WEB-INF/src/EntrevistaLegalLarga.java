	...
	*/
	...
	{	
		...
		try
		{
			...
			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("1.- ¿Dónde nació usted? Y enuncie por favor zona de residencia en su país de origen: Zona Rural o Zona Urbana."));			
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q1").toString(), fNormal));
			
			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("2.- ¿Diga a qué se dedicaba en su país de origen?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q2").toString(), fNormal));

			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("3.- ¿Diga quienes componen su núcleo familiar?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q3").toString(), fNormal));
			
			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("4.- ¿Diga si tiene familiares en Panamá?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q4").toString(), fNormal));
			
			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("5.- ¿Que miembros de su núcleo familiar todavía permanecen en su país de origen y esperan reunirse con usted?"));
			...
			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("9.- ¿Al ingresar al país se anunció como solicitante de refugio ante alguna autoridad?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q9").toString(), fNormal));

			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("10.- ¿Qué tipo de documentos de identidad personal posee?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q10").toString(), fNormal));

			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("11.- ¿Ha hecho usted algún trámite para regularizar su estatus en Panamá?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q11").toString(), fNormal));

			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("12.- ¿Diga usted si genera algún tipo de ingresos en Panamá?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q12").toString(), fNormal));

			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("13.- ¿Diga cómo sufraga sus gastos aquí en Panamá?"));
			...
			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("20.- ¿Qué lo/la motivo venir a Panamá?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q20").toString(), fNormal));

			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("21.- ¿Diga, cuales son las causas o motivos por la cual sale de su país de origen?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q21").toString(), fNormal));

			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("22.- ¿Qué tipo de amenazas recibía?"));
			doc.add(new Paragraph(session.getAttribute("temp_solicitante_v2_q22").toString(), fNormal));

			doc.add(new Paragraph(" "));
			doc.add(new Paragraph("23.- ¿Diga si otros miembros de su familia han sido víctima de amenazas?"));
