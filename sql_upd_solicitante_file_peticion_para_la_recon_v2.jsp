...
<%
	...
	params.add("Subió petición de reconsideración a la dirreción.");
...
<%
	...
	String mQuery = "update declaracion_jurada set " + 
					"adm_estatus_lkup = if(adm_estatus_lkup='No admitido/a a trámite - original','En proceso - reconsideración',adm_estatus_lkup), " +
					"adm_fecha_de_pedir_recon = ? , " +
	...
	String mAdm_fecha_de_pedir_recon = null;
      ...
      try{ 
         ...
         while ( i.hasNext () ) 
         {
            ...
            if ( !fi.isFormField () )	
            {
				...
				} else if (fieldName.equals("adm_fecha_de_pedir_recon")) {
				 	mAdm_fecha_de_pedir_recon = fi.getString();
				}  
            }
         }
...
<%
	...
	try{
		if (session.getAttribute("email") != null) {
			...
			prest.setString(1,mAdm_fecha_de_pedir_recon);
