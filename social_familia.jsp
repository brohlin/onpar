...
<fieldset>
<table id="register_family_members_social" border="0" cellspacing="2" cellpadding="4" width="600">
...
%>
	<input id="num_fam_members_social" name="num_fam_members_social" type="hidden" value="<%= size %>">
</table>
<table>
		
	<tr>
		<td colspan="3">
			<button id="add_row_social" >Añadir</button>
		</td>
		<td  colspan="2">
			<button id="delete_row_social">Eliminar</button>
		</td>
	</tr>
</table>
</fieldset>
