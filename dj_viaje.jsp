...
<table border="0" cellspacing="2" cellpadding="4" width="600">
	...
	<tr class="datatablerowv2">
		<td colspan="4">Fecha de la partida del país de residencia: <input type="date"  name="pre_fecha_de_salida_origen" value="<%= session.getAttribute("temp_solicitante_v2_pre_fecha_de_salida_origen") %>"></td>
	<tr>
...
%>
	...
	<tr class="datatablerowaltv2">
	    ...
	    <td><input type="date"  name="pre_viaje1_desde" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje1_desde") %>"></td>
	    <td><input type="date"  name="pre_viaje1_hasta" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje1_hasta") %>"></td>
	...
	<tr class="datatablerowaltv2">
	    ...
	    <td><input type="date"  name="pre_viaje2_desde" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje2_desde") %>"></td>
	    <td><input type="date"  name="pre_viaje2_hasta" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje2_hasta") %>"></td>
	    ...
	    <td><input type="date"  name="pre_viaje3_desde" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje3_desde") %>"></td>
	    <td><input type="date"  name="pre_viaje3_hasta" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje3_hasta") %>"></td>
	...
	<tr class="datatablerowaltv2">
	    ...
	    <td><input type="date"  name="pre_viaje4_desde" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje4_desde") %>"></td>
	    <td><input type="date"  name="pre_viaje4_hasta" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje4_hasta") %>"></td>
	...
	<tr class="datatablerowaltv2">
	    ...
	    <td><input type="date"  name="pre_viaje5_desde" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje5_desde") %>"></td>
	    <td><input type="date"  name="pre_viaje5_hasta" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje5_hasta") %>"></td>
	...
	<tr class="datatablerowaltv2">
	    ...
	    <td><input type="date"  name="pre_viaje6_desde" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje6_desde") %>"></td>
	    <td><input type="date"  name="pre_viaje6_hasta" value="<%= session.getAttribute("temp_solicitante_v2_pre_viaje6_hasta") %>"></td>
