...
<%
	...
	params.add("Actualizó decisión original del case por la comisión.");
...
<%
	...
	try{
		if (session.getAttribute("email") != null) {
			...
			prest.setString(1,request.getParameter("ref_fecha_resol"));
			prest.setString(2,request.getParameter("ref_dec_resol_lkup"));
			prest.setString(3,request.getParameter("ref_dec_resol_memo"));
			prest.setString(4,request.getParameter("ref_dec_resol_lkup"));
