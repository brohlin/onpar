...
<%
	String mQuery2 = "select format(id,'0'), format(solicitante_id,'0'), ifnull(dsc,''), f_format_date(fecha_ampliacion) from ampliacion where solicitante_id = ?";
	
	String mId2 = "";
	String mSolicitante_id2 = "";
	String mDesc2 = "";
	String mFecha_ampliacion = "";
...
%>
			...
			<tr>
				...
				Ampliaciones a la entrevista legal
				</td>			
			</tr>			
<%
			while(rs2.next())
			{
				...
				mFecha_ampliacion = rs2.getString(4);
%>

				<tr>
					<td nowrap>
						<a href="sql_get_ampliacion_v2.jsp?id=<%= mId2 %>"><%= mDesc2 %></a>
					</td>					
				</tr>
<%
			}
