...
<form action="sql_ins_miembro_de_familia.jsp" method="post" name="ins_familia">
...
<tr>
	<td colspan="2">			
	Utilice este forumulario para añadir un miembro de la familia de un solicitante.
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<input type="text" tabindex="<%= mCounter++ %>" name="nombre" value="" required="required" size="30" maxlength="45" autofocus="autofocus">
	</td>
</tr>
...
<tr>
	...
	<td>
		<input type="number" min="0" max="125" tabindex="<%= mCounter++ %>" name="edad" value="" required="required" size="30" maxlength="45">
	</td>
</tr>

<tr>
	<td align="right">Parentesco
	</td>
	<td>
		<select name="parentesco_lkup" tabindex="<%= mCounter++ %>" size="1">
		<option value=""></option>
...
<tr>
	<td align="right">
	<span class="smRedTxt">*</span> Ubicación
	</td>
	<td>
		<input type="text" tabindex="<%= mCounter++ %>" name="ubicacion" value="" required="required" size="30" maxlength="45">
	</td>
</tr>
...
<%
	String mPais = "";  		 
%>
	<select name="pais_lkup" tabindex="<%= mCounter++ %>" size="1">
		<option value=""></option>
		...
		<option value="la República Dominicana"<% if (mPais.equals("la República Dominicana")) {%> selected <% } %>>la República Dominicana</option>
...
<tr>
	<td align="right">
	<span class="smRedTxt">*</span> Ocupación
	</td>
	<td>
		<input type="text" tabindex="<%= mCounter++ %>" name="ocupacion" value="" required="required" size="30" maxlength="45">
	</td>
</tr>
<!--- Submit/cancel. --->
<tr>
