...
<%
	String mQuery = "insert into declaracion_jurada (" + 
					...
					"pre_estatus_lkup, " +
					"adm_estatus_lkup ) " + 
					"values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,now(),'Digitalizar Caso Cerrado','Digitalizar Caso Cerrado')";
						
	String p_pre_primer_nombre = request.getParameter("pre_primer_nombre");
	System.out.print(request.getParameter("pre_primer_nombre"));
	System.out.println(p_pre_primer_nombre);
