...
<table border="0" cellspacing="2" cellpadding="4" width="600">
	...
	<tr class="datatablerowaltv2">
	    ...
	    <td><input type="date"  name="pre_org_desde" value="<%= session.getAttribute("temp_solicitante_v2_pre_org_desde") %>"></td>
	    <td><input type="date"  name="pre_org_hasta" value="<%= session.getAttribute("temp_solicitante_v2_pre_org_hasta") %>"></td>
	...
	<tr class="datatablerowaltv2">
	    ...
	    <td><input type="date"  name="pre_org_desde2" value="<%= session.getAttribute("temp_solicitante_v2_pre_org_desde2") %>"></td>
	    <td><input type="date"  name="pre_org_hasta2" value="<%= session.getAttribute("temp_solicitante_v2_pre_org_hasta2") %>"></td>
