...
<%
	...
	params.add("Subió petición de apelación a la dirección.");
...
<%
	...
	String mQuery = "update declaracion_jurada set " +
					"adm_estatus_lkup = if(adm_estatus_lkup='No admitido/a a trámite - reconsideración','En proceso - apelación',adm_estatus_lkup), " +	
					"adm_fecha_de_pedir_apel = ? , " +
	...
	String mAdm_fecha_de_pedir_apel = null;
      ...
      try{ 
         ...
         while ( i.hasNext () ) 
         {
            ...
            if ( !fi.isFormField () )	
            {
				...
				} else if (fieldName.equals("adm_fecha_de_pedir_apel")) {
				 	mAdm_fecha_de_pedir_apel = fi.getString();
				}  
            }
         }
...
<%
	...
	try{
		if (session.getAttribute("email") != null) {
			...
			prest.setString(1,mAdm_fecha_de_pedir_apel);
