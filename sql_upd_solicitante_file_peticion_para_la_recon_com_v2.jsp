...
<%
	...
	params.add("Subió petición de reconsideración a la comisión.");
...
<%
	...
	String mQuery = "update declaracion_jurada set " + 
					"ref_estatus_lkup = if(ref_estatus_lkup='No admitido/a a trámite - original - Comisión','En proceso - reconsideración - Comisión',ref_estatus_lkup), " +
					"ref_fecha_de_pedir_recon = ? , " +
	...
	String mRef_fecha_de_pedir_recon = null;
      ...
      try{ 
         ...
         while ( i.hasNext () ) 
         {
            ...
            if ( !fi.isFormField () )	
            {
				...
				} else if (fieldName.equals("ref_fecha_de_pedir_recon")) {
				 	mRef_fecha_de_pedir_recon = fi.getString();
				}  
            }
         }
...
<%
	...
	try{
		if (session.getAttribute("email") != null) {
			...
			prest.setString(1,mRef_fecha_de_pedir_recon);
