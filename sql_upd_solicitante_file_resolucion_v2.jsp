...
<%
	...
	params.add("Subió resolución de solicitante.");
...
<%
	...
	String mFecha_de_resolucion = null;
      ...
      try{ 
         ...
         while ( i.hasNext () ) 
         {
            ...
            if ( !fi.isFormField () )	
            {
				...
				} else if (fieldName.equals("fecha_de_resolucion")) {
				 	mFecha_de_resolucion = fi.getString();
				 	System.out.println("Fecha de resolucion " + mFecha_de_resolucion);
				}  
            }
         }
...
<%
	...
	try{
		if (session.getAttribute("email") != null) {
			...
			prest.setString(1,mFecha_de_resolucion);
