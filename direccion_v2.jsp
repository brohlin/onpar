<details>
<summary>Decisión de la Dirección/Estatus: <strong><%= session.getAttribute("temp_solicitante_v2_adm_estatus_lkup") %></strong></summary>
...
%>
		...
		<tr><td align="left" valign="top"><span class="smRedTxt">*</span>Razón por la decisión: </td><td><textarea  name="adm_dec_resol_memo" required="required" cols="50" rows="4" maxlength="200"></textarea></td></tr>
...
<%
	} else if (session.getAttribute("temp_solicitante_v2_adm_estatus_lkup").equals("En proceso - reconsideración")) {
%>		
		...
		<tr><td align="left" valign="top"><span class="smRedTxt">*</span>Razón por la decisión de la reconsideración: </td><td><textarea name="adm_dec_resol_recon_memo" required="required" cols="50" rows="4" maxlength="200"></textarea></td></tr>
