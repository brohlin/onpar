...
<%
	...
	String mQuery = "update solicitante set " + 
					"adm_estatus_lkup = if(pre_declaracion_jurada is not null and pre_entrevista_social is not null and renuncia is null,'En proceso - original',adm_estatus_lkup), " +
